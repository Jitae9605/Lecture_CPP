...
int main(void)
{
	FruitSeller seller;					// 과일판매자 (seller)
	seller.InitMemebers(1000, 20, 0);	// 과일 1개 가격 = 1000원, 현재고 = 20개, 초기자금 = 0원

	FruitBuyer buyer;					// 과일구매자 (buyer)
	buyer.InitMemebers(5000);			// 초기자금 = 5000원
